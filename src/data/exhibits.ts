export interface Exhibit {
  ...
  tags?: string[];
  highlight?: string;
  images?: string[]; // paths to artwork images
}
    ...
    exhibits: [
      {
        ...
        description:
          'Bachelor and Master of Science in Mechanical Engineering with Managerial Analytics from Kellogg School of Business and a Minor in Economics.',
        stats: [
      ...
      },
      {
        ...
        description:
          "Immersion program to understand China's modern political history, current economic and policy changes. A formative experience bridging Eastern and Western perspectives.",
      ...
      },
      {
        ...
        subtitle: '2006',
        description:
          "Awarded the prestigious Public Service Commission Overseas Merit Scholarship - one of Singapore's most competitive scholarships for outstanding students committed to public service.",
    ...
    exhibits: [
      {
        ...
        description:
          "Prepared policy positions for safeguarding Singapore's strategic interests vis-a-vis neighbouring countries. Operated at the intersection of national security and diplomacy.",
      ...
      },
      {
        ...
        description:
          "Scaled up student care centres in primary schools and led major policy reviews that shaped Singapore's education landscape.",
        stats: [
        ...
        links: [
          {
            label: 'PSLE Scoring Reform',
            url: 'https://www.moe.gov.sg/psle-fsbb/psle/changing-psle-scoring-system',
          },
        ],
        highlight:
          'Led team that reviewed and changed the PSLE scoring system - affecting every primary school student in Singapore',
      ...
      },
      {
        ...
        description:
          'Obtained Cabinet approval for old vehicle turnover schemes and represented Singapore at ASEAN-level meetings on transboundary haze.',
        stats: [{ label: 'Health Benefits', value: '>$100M' }],
        links: [
          {
            label: 'Carbon Emissions Requirements',
            url: 'https://www.channelnewsasia.com/singapore/nea-steps-carbon-emissions-requirements-foreign-vehicles-motorcycles-entering-singapore-4448276',
          },
          {
            label: 'ASEAN Haze Meeting',
            url: 'https://www.channelnewsasia.com/singapore/asean-haze-meeting-ends-disappointing-bewildering-note-5794066',
          },
        ],
    ...
    exhibits: [
      {
        ...
        description:
          'Led product development at this innovative smart helmet startup. Built and managed a team of 3 product managers and served as 1 of 3 executive members overseeing engineering, product development, and production.',
        stats: [
        ...
        images: ['/assets/lumos-1.png', '/assets/lumos-2.png'],
      },
      {
        id: 'lumos-apple',
        ...
        description:
          'Led the team to develop the award-winning Lumos Matrix - selected by Apple as the FIRST helmet product to be launched in 300+ Apple Stores worldwide.',
        ...
        images: ['/assets/lumos-3.png'],
      },
      {
        id: 'lumos-product',
        title: 'Product Innovation',
        description:
          'Built products with integrated LED turn signals, brake lights, and companion app - merging safety technology with sleek consumer design.',
        tags: ['LED Technology', 'Companion App', 'Safety Innovation', 'Consumer Hardware'],
        images: ['/assets/lumos-4.png'],
      },
    ],
  },
  {
    ...
    exhibits: [
      {
        ...
        description:
          'Started a risk management programme across 8 markets to tackle fraud and mis-operation losses. Made more than 100 recommendations adopted by management.',
        stats: [
          { label: 'Markets Covered', value: '8' },
          { label: 'Recommendations', value: '100+' },
        ],
        highlight:
          'Received Values-in-Action award - given to only 3 product leaders in entire company in 2022',
      ...
      },
      {
        ...
        description:
          'Led team of 4 to pursue growth through O2O events, strategic seller onboarding, and ecosystem partnerships with major tech companies.',
        stats: [
      ...
      },
      {
        ...
        description:
          'Led a 16-person team to dramatically improve logistics operations across multiple performance dimensions.',
        stats: [
      ...
      },
      {
        ...
        description:
          'Led the effort to transform manual Fulfillment warehouse into a fully robotic setup. Built business case to convince top management to invest in a $16M USD Tote-to-Man automation solution.',
        stats: [
        ...
        links: [
          {
            label: 'Automation Study',
            url: 'https://docs.google.com/presentation/d/1rwjawFpnwFt9oA-tUvaurmd1cdSJ656b_Hw78ICx_zw/edit',
          },
        ],
        tags: ['Robotics', 'Tote-to-Man', 'Business Case', 'Capex Planning', '5 Vendors Evaluated'],
        images: [
          '/assets/wh-exec-summary.png',
          '/assets/wh-tote-to-man.png',
          '/assets/wh-solutions-tradeoffs.png',
          '/assets/wh-recommendations.png',
          '/assets/wh-business-case.png',
          '/assets/wh-floorplan-apr26.png',
          '/assets/wh-floorplan-aug27.png',
          '/assets/wh-industry-landscape.png',
          '/assets/wh-with-automation.png',
        ],
      },
    ],
  },
    ...
    exhibits: [
      {
        ...
        description:
          'Overall champion for driving AI adoption across Shopee Singapore. Leads 29 product managers overseeing all Product pillars while fostering an AI-first culture across the organization.',
        stats: [
      ...
      },
      {
        ...
        description:
          'AI projects span every business function, with measurable financial impact across all domains.',
        stats: [
      ...
      },
      {
        ...
        description:
          'A pipeline of 95 AI projects across 7 domains, from proof-of-concept to fully live deployments.',
        stats: [
          { label: 'Live', value: '23' },
        ...
        links: [
          {
            label: 'Live AI Project Backlog',
            url: 'https://web-production-5ec5.up.railway.app/',
          },
        ],
      },
    ],
